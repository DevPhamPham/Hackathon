const Hero = () => {
  return (
    <section className="min-h-screen relative flex flex-1 shrink-0 items-center justify-center overflow-hidden bg-gray-100 py-16 shadow-lg md:py-20 xl:py-48">
      <img
      ...
      <div className="relative min-w-[70%] flex flex-col items-center p-4 sm:max-w-xl">
        ...
        <h1 className="mb-8 text-center text-4xl font-bold text-white sm:text-5xl md:mb-12 md:text-6xl">
          Revolutionary way to charity donation using{" "}
          <span className="text-primary-700">Blockchain</span>
        </h1>
